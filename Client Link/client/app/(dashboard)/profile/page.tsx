...
const ProfilePage = async () => {
    ...
    kyc = await readKyc(userId || null)
    coloredToast('error', "User not found")
                ...
                <div className="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-3 xl:grid-cols-4">
                    <div className="panel">
                        <div className="mb-5 flex items-center justify-between">
                            ...
                            <Link href="#" className="btn btn-primary rounded-full p-2 ltr:ml-auto rtl:mr-auto">
                        ...
                        <div className="mb-5">
                            <div className="flex flex-col items-center justify-center">
                                ...
                                <p className="text-xl font-semibold text-primary">{kyc?.first_name} { kyc.last_name}</p>
                            </div>
                            <ul className="m-auto mt-5 flex max-w-[160px] flex-col space-y-4 font-semibold text-white-dark">
                                ...
                                <li>
                                    <button className="flex items-center gap-2">
                                        ...
                                        <span className="text-primary">{kyc?.email}</span>
                                    </button>
                                </li>
                                <li className="flex items-center gap-2">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
